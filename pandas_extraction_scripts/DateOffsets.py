...
html_page = urllib.request.urlopen("https://pandas.pydata.org/docs/reference/offset_frequency.html")
soup = BeautifulSoup(html_page, "html.parser")
PATH = "https://pandas.pydata.org/docs/reference/"
all_links = list(soup.findAll('a'))[16:]
for i,link in enumerate(all_links):
	...
	try:
		...
		if actual_stuff[:6] != 'pandas':
			actual_stuff = 'pd.tseries.offsets.' + actual_stuff[:]
